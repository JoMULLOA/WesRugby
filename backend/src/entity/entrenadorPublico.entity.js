...
const EntrenadorPublicoSchema = new EntitySchema({
  ...
  columns: {
    ...
    categorias: {
      ...
      length: 500,
      nullable: true,
      comment: "Categorías que entrena (ej: sub-8, sub-10)",
    },
    visible: {
      type: "boolean",
      default: true,
    ...
    fotoPath: {
      ...
      length: 500,
      nullable: true,
      comment: "Ruta del archivo de foto p�blica del entrenador",
    },
    fotoVersion: {
      type: "int",
      default: 0,
      nullable: false,
      comment: "Versi�n de la foto p�blica para control de cach�",
    },
    createdAt: {
