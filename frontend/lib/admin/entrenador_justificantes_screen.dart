...
class EntrenadorJustificantesScreen extends StatefulWidget {
  ...
  @override
  State<EntrenadorJustificantesScreen> createState() => _EntrenadorJustificantesScreenState();
}

class _EntrenadorJustificantesScreenState extends State<EntrenadorJustificantesScreen> {
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: Row(
              children: [
                Icon(Icons.info_outline, color: WessexColors.deepRoyalBlue, size: 20),
              ...
              Expanded(
                child: TextField(
                  decoration: InputDecoration(
                    ...
                    prefixIcon: Icon(Icons.search, color: WessexColors.leafGreen),
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      children: [
                        Icon(Icons.calendar_today, size: 16, color: WessexColors.leafGreen),
                    ...
                    Row(
                      children: [
                        Icon(Icons.edit_note, size: 16, color: WessexColors.leafGreen),
                        const SizedBox(width: 8),
                        Expanded(
                          child: Text(
                    ...
                    if (justificante['descripcion'] != null && justificante['descripcion'].isNotEmpty) ...[
                      ...
                      Row(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Icon(Icons.description, size: 16, color: WessexColors.leafGreen),
                          const SizedBox(width: 8),
                          Expanded(
                            child: Text(
                    ...
                    if (justificante['archivo'] != null) ...[
                      ...
                      Row(
                        children: [
                          Icon(Icons.attachment, size: 16, color: WessexColors.leafGreen),
                          const SizedBox(width: 8),
                          Text(
              ...
              Container(
                ...
                child: Row(
                  children: [
                    Icon(Icons.access_time, size: 14, color: WessexColors.leafGreen),
