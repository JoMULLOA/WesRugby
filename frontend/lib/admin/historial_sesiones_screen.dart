...
class _HistorialSesionesScreenState extends State<HistorialSesionesScreen> {
            ...
            child: Column(
              ...
              children: [
                          ...
                          Expanded(
                            child: DropdownButtonFormField<String>(
                              ...
                              decoration: InputDecoration(
                                ...
                                prefixIcon: Icon(Icons.class_, color: WessexColors.crimsonAlert),
                              ),
                              isExpanded: true,
                              ...
                              items: [
                                ...
                                ..._cursosDisponibles.map((curso) => DropdownMenuItem<String>(
                                  value: curso,
                                  child: Text(curso),
                                )).toList(),
                              ],
                              onChanged: (value) => setState(() => _cursoFiltro = value),
                            ),
                          ),
                          const SizedBox(width: 16),
                          ElevatedButton.icon(
                            ...
                            icon: Icon(Icons.refresh, color: WessexColors.white, size: 20),
                            label: Text(
                              'Actualizar',
                ...
                if (_isLoadingSesiones)
                  ...
                  ..._getSesionesFiltradas().map((sesion) => _buildSesionCard(sesion)).toList(),
              ],
            ),
          ),
        ),
  ...
  Widget _buildDetalleAsistencia(Map<String, dynamic> detalle) {
    ...
    int justificados = registros.where((r) => r['estado'] == 'justificado').length;
    ...
    return Column(
      ...
      children: [
        ...
        Row(
          children: [
            Expanded(child: _buildMiniStat('Presentes', presentes.toString(), WessexColors.leafGreen)),
            Expanded(child: _buildMiniStat('Ausentes', ausentes.toString(), WessexColors.crimsonAlert)),
            Expanded(child: _buildMiniStat('Justificados', justificados.toString(), WessexColors.deepRoyalBlue)),
            Expanded(child: _buildMiniStat('% Asistencia', '${porcentajeAsistencia.toStringAsFixed(1)}%', WessexColors.darkGrape)),
          ],
        ),
          ...
          return Container(
            ...
            child: Row(
              children: [
                ...
                Expanded(
                  child: Text(
                    registro['nombreEstudiante'] ?? 'Estudiante ${registro['rutEstudiante']}',
