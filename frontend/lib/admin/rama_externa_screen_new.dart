...
class _RamaExternaScreenState extends State<RamaExternaScreen>
        ...
        child: Column(
          ...
          children: [
            ...
            if (evento['tipoEvento'] != null) ...[
              ...
              Row(
                children: [
                  Icon(Icons.sports_soccer, size: 16, color: WessexColors.midnightNavy),
                  SizedBox(width: 8),
                  Text(
                ...
                children: [
                          ...
                          Row(
                            children: [
                              ...
                              if (participaciones.length > 1)
                                IconButton(
                                  icon: Icon(Icons.remove_circle, color: WessexColors.crimsonAlert),
                                  onPressed: () {
                                    setStateDialog(() {
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      SizedBox(width: 16),
                      ElevatedButton(
                        onPressed: () => _confirmarParticipacionMultiple(evento, participaciones),
                        style: ElevatedButton.styleFrom(
                          backgroundColor: WessexColors.leafGreen,
                          foregroundColor: Colors.white,
  ...
  Widget _buildDetalleEventoDialog(Map<String, dynamic> evento) {
    return Column(
      ...
      children: [
        ...
        Row(
          children: [
            Icon(Icons.calendar_today, size: 14, color: WessexColors.midnightNavy),
            SizedBox(width: 8),
            Text(
              DateTime.parse(evento['fecha']).toLocal().toString().split(' ')[0],
        ...
        if (evento['lugar'] != null && evento['lugar'].toString().isNotEmpty) ...[
          ...
          Row(
            children: [
              Icon(Icons.location_on, size: 14, color: WessexColors.midnightNavy),
              SizedBox(width: 8),
              Expanded(
                child: Text(
                  evento['lugar'],
        ...
        if (evento['tipoEvento'] != null) ...[
          ...
          Row(
            children: [
              Icon(Icons.sports_soccer, size: 14, color: WessexColors.midnightNavy),
              SizedBox(width: 8),
              Text(
                'Tipo: ${evento['tipoEvento']}',
                style: TextStyle(fontSize: 13, color: WessexColors.midnightNavy),
  ...
  Future<void> _confirmarParticipacionMultiple(Map<String, dynamic> evento, List<Map<String, dynamic>> participaciones) async {
    ...
    try {
      ...
      for (final participacion in participaciones) {
        final datos = {
          ...
          'listaInvitados': participacion['invitados'].text.trim().isEmpty ? null : participacion['invitados'].text.trim(),
        };
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text('${participaciones.length} participación(es) registrada(s) exitosamente'),
          backgroundColor: WessexColors.leafGreen,
        ),
      );
    } catch (e) {
