...
class _TomarAsistenciaScreenState extends State<TomarAsistenciaScreen> {
  ...
  final List<String> _estadosAsistencia = ['presente', 'ausente', 'justificado'];
  ...
  Future<void> _guardarAsistencia() async {
    ...
    try {
      ...
      final sesionAsistencia = {
        ...
        'asistencias': _asistenciaEstudiantes.entries.map((entry) => {
          'rutEstudiante': entry.key,
          'nombreEstudiante': estudiantesCurso.firstWhere(
            (e) => e['rut'] == entry.key, 
                    ...
                    children: [
                      ...
                      TextFormField(
                        ...
                        decoration: InputDecoration(
                          ...
                          prefixIcon: Icon(Icons.sports_rugby, color: WessexColors.deepRoyalBlue),
                        ),
                      ),
                      ...
                      InkWell(
                        ...
                        child: Container(
                          ...
                          child: Row(
                            children: [
                              Icon(Icons.calendar_today, color: WessexColors.leafGreen),
                              const SizedBox(width: 16),
                              Text(
                    ...
                    children: [
                      ...
                      if (_isLoadingEstudiantes)
                        ...
                        DropdownButtonFormField<String>(
                          ...
                          items: _cursosDisponibles.map((curso) => DropdownMenuItem<String>(
                            value: curso,
                            child: Text(curso),
                          )).toList(),
            ...
            children: [
              ...
              Expanded(
                child: OutlinedButton(
                  ...
                  child: Text(
                    'Todos Ausentes',
                    style: TextStyle(color: WessexColors.crimsonAlert, fontSize: 12),
                  ),
                ),
              ),
            ],
            ...
            return Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 12),
                  Row(
                    children: _estadosAsistencia.map((estado) {
                      final isSelected = estadoAsistencia == estado;
                      return Expanded(
                        child: Padding(
                          padding: const EdgeInsets.symmetric(horizontal: 4),
                          child: OutlinedButton(
                            onPressed: () => _cambiarAsistencia(rut, estado),
                            style: OutlinedButton.styleFrom(
