    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        ScaffoldMessenger.of(
          context,
        ).showSnackBar(const SnackBar(content: Text('Inscripción rechazada')));
      }
    } catch (e) {
      ScaffoldMessenger.of(context).showSnackBar(
                    ...
                    return Card(
                      ...
                      child: ListTile(
                        ...
                        subtitle: Column(
                          ...
                          children: [
                            Text(
                              'Categoría: ${inscripcion['categoria'] ?? 'No especificada'}',
                            ),
                ...
                onPressed: () async {
                  if (formKey.currentState!.validate()) {
                    try {
                      ...
                      ScaffoldMessenger.of(context).showSnackBar(
                        SnackBar(
                          content: Text('Error creando inscripción: $e'),
                        ),
                      );
                    }
                  }
