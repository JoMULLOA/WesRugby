...
class HistorialVouchersScreen extends StatefulWidget {
  ...
  @override
  State<HistorialVouchersScreen> createState() =>
      _HistorialVouchersScreenState();
}
...
class _HistorialVouchersScreenState extends State<HistorialVouchersScreen> {
  ...
  Widget _buildStatCard(
    ...
    return Container(
      ...
      child: Column(
        children: [
          Icon(icon, color: color, size: isDesktop ? 24 : (isTablet ? 22 : 20)),
      ...
      child: Column(
        ...
        children: [
          ...
          if (isDesktop) ...[
            ...
            Row(
              children: [
                Expanded(child: _buildMesDropdown(mesesDisponibles)),
                const SizedBox(width: 16),
