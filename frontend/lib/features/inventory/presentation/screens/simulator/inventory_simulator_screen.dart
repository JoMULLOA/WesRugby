...
class _InventorySimulatorScreenState extends State<InventorySimulatorScreen> {
  ...
  static const Map<String, String> _categoryLabels = {
    ...
    'bebidas_energeticas': 'Bebidas Energ�ticas',
    'varios': 'Varios',
  };
  @override
  void initState() {
  ...
  Future<void> _downloadSheet({String? category}) async {
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text('Hoja de c�digos guardada en ' + file.path)),
      );
    } catch (error) {
      if (!mounted) return;
      ScaffoldMessenger.of(context).showSnackBar(
  ...
  Future<void> _createVariosSale(InventoryProductModel? varios) async {
    ...
    try {
      ...
      // por lo tanto el valor ingresado se envía directamente (1500 pesos = 1500 "centavos")
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                            ...
                            Expanded(
                              child: TextField(
                                ...
                                decoration: const InputDecoration(
                                  ...
                                  hintText: 'Ej: 1500',
                                  helperText: 'Ingresa solo números (sin puntos ni comas)',
                                ),
                              ),
                            ),
                        ...
                        if (varios != null)
                          Text('C�digo actual: ' + varios.barcode),
                      ],
                    ),
                  ),
                ),
