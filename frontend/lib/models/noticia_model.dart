class NoticiaModel {
  ...
  factory NoticiaModel.fromJson(Map<String, dynamic> json) {
    return NoticiaModel(
      ...
      fechaPublicacion: DateTime.parse(json['fechaPublicacion'] ?? DateTime.now().toIso8601String().split('T')[0]),
      ...
      fechaCreacion: DateTime.parse(json['createdAt'] ?? DateTime.now().toIso8601String()),
      fechaActualizacion: DateTime.parse(json['updatedAt'] ?? DateTime.now().toIso8601String()),
    );
  }
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'imagen': imagen,
      'fechaPublicacion': fechaPublicacion.toIso8601String().split('T')[0], // Solo la fecha
      'estado': estado,
      'destacada': destacada,
      'orden': orden,
