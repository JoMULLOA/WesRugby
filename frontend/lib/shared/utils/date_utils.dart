...
class DateUtils {
  ...
  /// Esto evita que aparezcan viajes del día anterior que en UTC parecen del día buscado
  static Map<String, DateTime> fechaChileARangoUtcBusqueda(
    DateTime fechaChile,
  ) {
    // Crear el inicio del día en Chile (00:00)
    final inicioDiaChile = DateTime(
  ...
  static bool esMismoDiaEnChile(
    DateTime fechaUtcMongo,
    DateTime fechaSeleccionadaChile,
  ) {
