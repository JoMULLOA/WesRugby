...
class CustomNavbarConNotificaciones extends StatefulWidget {
  ...
  @override
  _CustomNavbarConNotificacionesState createState() =>
      _CustomNavbarConNotificacionesState();
}

class _CustomNavbarConNotificacionesState
    extends State<CustomNavbarConNotificaciones> {
  ...
  Future<void> _cargarNotificaciones() async {
    try {
      final numero =
          await NotificacionService.obtenerNumeroNotificacionesPendientes();
      if (mounted) {
        setState(() {
        ...
        if (_numeroNotificaciones > 0)
          Positioned(
            ...
            child: Container(
              ...
              child: Text(
                _numeroNotificaciones > 99
                    ? '99+'
                    : _numeroNotificaciones.toString(),
                style: TextStyle(
                  color: Colors.white,
                  fontSize: 10,
