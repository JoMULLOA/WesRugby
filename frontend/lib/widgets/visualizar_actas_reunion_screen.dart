...
class VisualizarActasReunionScreen extends StatefulWidget {
  ...
  @override
  State<VisualizarActasReunionScreen> createState() => _VisualizarActasReunionScreenState();
}

class _VisualizarActasReunionScreenState extends State<VisualizarActasReunionScreen> {
  ...
  Future<void> _cargarActas() async {
    ...
    try {
      ...
      final response = await ApiService.obtenerActasReunion(estado: 'publicada');
        ...
        content: SingleChildScrollView(
          child: SizedBox(
            ...
            child: Column(
              ...
              children: [
                // Información básica
                _buildInfoRow('Fecha', DateFormat('dd/MM/yyyy').format(DateTime.parse(acta['fecha']))),
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: const Row(
                      mainAxisSize: MainAxisSize.min,
                      children: [
                        Icon(Icons.public, size: 16, color: WessexColors.leafGreen),
                        SizedBox(width: 4),
                        Text(
                          'PUBLICADA',
                          style: TextStyle(
              ...
              Container(
                ...
                child: const Column(
                  ...
                  children: [
                    Row(
                      children: [
                        Icon(Icons.info_outline, color: WessexColors.deepRoyalBlue),
                        SizedBox(width: 8),
                        Text(
